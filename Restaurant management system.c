...
int main_page(){
    int i;
    system("cls");
    printf("\n\n\n\t\t      -$- Welcome to Cafe Good day -$- \t\t\n\n");
    printf("\n\t\t\t Good Quality Food and Services \t\t\t\n");
     for (i=0;i<40;i++)
     {
        printf("~");
     }
     printf("Your destined place");
      for (i=0;i<40;i++)
     {
        printf("~");
     }
  ...
  int menu_order()
{
    ...
    printf("\t1. Dosa ...................... 120/=\t  \n");
    printf("\t2. Idli ..........................  40/=\n");
    printf("\t3.  Manchrian...........................  70/=\t \n");
    printf("\t4. French Fries (FnF Pack) ..........  90/=\t \n");
    printf("\t\t\t\t\t\t\t \n\n\tMain course :\n\n");
    printf("\t5. Dal Rice ...................  90/=\n");
    printf("\t6. Veg Biryani ....................  65/=\n");
    printf("\n\tDESSERTS :\n\t\t\t\t\t\t\t \n");
...
int Bill_show(int arID[],int arqty[],int counter)
{
    ...
    char items[10][16]={"Dosa","Idli","Manchurian","French Fries","Dal Rice","Veg Biryani","Ice Cream","Sweets","Coca-Cola","Mirinda"};
